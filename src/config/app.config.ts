        ...
        this.qaConfig = {
            ...
            textExtraction: {
                ...
                pythonService: {
                    ...
                    timeout: parseInt(
                        process.env.PDF_SERVICE_TIMEOUT || "10000"
                    ), // 10 seconds timeout
            ...
            toolCalls: {
                ...
                advanced: {
                    ...
                    timeoutMs: parseInt(
                        process.env.TOOLCALLS_TIMEOUT_MS || "8000"
                    ),
                    maxBytes: parseInt(
                        process.env.TOOLCALLS_MAX_BYTES || "2000000"
                    ),
                    concurrency: parseInt(
                        process.env.TOOLCALLS_CONCURRENCY || "2"
                    ),
                    respectRobotsTxt:
                        process.env.TOOLCALLS_RESPECT_ROBOTS !== "false",
                    allowedDomains: (
                        process.env.TOOLCALLS_ALLOWED_DOMAINS || ""
                    )
                        .split(",")
                        .filter(Boolean),
                    deniedDomains: (
